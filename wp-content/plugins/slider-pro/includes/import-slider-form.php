<form id="import-slider-form" action="<?php echo admin_url('admin.php?page=slider_pro'); ?>" enctype="multipart/form-data" method="post">
	...
	<input type="file" name="import-slider-file" id="import-slider-input" size="35" />
    <input type="submit" name="import-slider-submit" class="button-secondary" value="<?php _e('Import Slider', 'slider-pro'); ?>"/>
</form> 