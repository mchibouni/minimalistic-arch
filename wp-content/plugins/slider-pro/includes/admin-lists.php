...
$sliderpro_slider_settings_lists = array('align_type' => array('leftTop', 'centerTop', 'rightTop', 'leftCenter', 'centerCenter', 'rightCenter', 'leftBottom', 
										 ...
										 'video_end_action' => array('resetVideo', 'startSlideshow', 'resumeSlideshow', 'nextSlide', 'none'),
										  
										 'leave_video_action' => array('stopVideo', 'pauseVideoAndBuffering', 'pauseVideo'),
										 
										 'reach_video_action' => array('none', 'playVideo'),
										 
										 'slide_types' => array('static', 'posts', 'gallery'),
...
$sliderpro_settings_pretty_name = array('leftTop' => 'Top Left', 'centerTop' => 'Top Center', 'rightTop' => 'Top Right', 'leftCenter' => 'Center Left', 'centerCenter' => 'Center Center', 
										'rightCenter' => 'Center Right', 'leftBottom' => 'Bottom Left', 'centerBottom' => 'Bottom Center', 'rightBottom' => 'Bottom Right',
									   	...
									   	'auto' => 'Auto', 'autoHorizontal' => 'Auto Horizontal', 'autoVertical' => 'Auto Vertical',
										
									   	'left' => 'Left', 'right' => 'Right', 'top' => 'Top', 'bottom' => 'Bottom', 
									   	'horizontalAlternate' => 'Horizontal Alternate', 'verticalAlternate' => 'Vertical Alternate',
										
									   	'custom' => 'Custom',
									   
									   	'horizontal' => 'Horizontal', 'vertical' => 'Vertical',
									   
									   	'scroller' => 'Scroller',  'tooltip' => 'Tooltip',  'tooltipAndScroller' => 'Tooltip And Scroller',
									   	...
									   	'noScale' => 'No Scale', 'exactFit' => 'Exact Fit', 'insideFit' => 'Inside Fit', 'outsideFit' => 'Outside Fit', 'proportionalFit' => 'Proportional',
									   
									   	'none' => 'None', 'stopSlideshow' => 'Stop Slideshow', 'pauseSlideshow' => 'Pause Slideshow', 'startSlideshow' => 'Start Slideshow', 
									   	'resumeSlideshow' => 'Resume Slideshow', 'resetVideo' => 'Reset Video', 'nextSlide' => 'Next Slide', 'startVideo' => 'Start Video', 
									   	'pauseVideo' => 'Pause Video', 'stopVideo' => 'Stop Video', 'playVideo' => 'Play Video', 'pauseVideoAndBuffering' => 'Pause Video And Buffering',
									   
									   	'slice' => 'Slice', 'slide' => 'Slide', 'swipe' => 'Swipe', 'fade' => 'Fade', 'scale' => 'Scale', 'width' => 'Width', 'height' => 'Height', 
									   	'random' => 'Random',
									   
									   	'date' => 'Date', 'comment_count' => 'Comments', 'title' => 'Title', 'rand' => 'Random',
									   
									   	'and' => 'AND', 'or' => 'OR',
									   
									   	'static' => 'Static', 'posts' => 'Posts Content', 'gallery' => 'Gallery Images', 
									   
									   	'c' => 'Center', 't' => 'Top', 'l' => 'Left', 'r' => 'Right', 'b' => 'Bottom', 'tl' => 'Top Left', 'tr' => 'Top Right', 
...
$sliderpro_properties_help = array('width' => __('The total width of the slider. 
												   Can be set in percentages if the \'%\' symbol is used or in pixels if only a number is used.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'lightbox' => __('Indicates whether the lightbox will be enabled.', 'slider_pro') .'<br/><br/><b>'. 
									...
									'caption_size' => __('Sets the width/height of the caption\'s background, unless the caption\'s position is \'custom\'', 'slider_pro') .'<br/><br/><b>'. 
...
// sidebar categories
$sliderpro_slider_sidebar_categories = array('publish' => 'Publish',
										 	 'general' => 'General',
											 'slideshow' => 'Slideshow',
											 'lightbox' => 'Lightbox',
											 'timer_animation' => 'Timer Animation',
											 'slide_navigation_controls' => 'Slide Navigation Controls',
											 'transition_effects' => 'Transition Effects',
											 'thumbnails' => 'Thumbnails',
											 'captions' => 'Captions',
											 'video' => 'Video',
											 'image_resizing' => 'Image Resizing',
											 'slides_order' => 'Slides Order');
