        ...
        <div class="metabox-holder has-right-sidebar">
            <div class="editor-wrapper meta-box-sortables">
                <div class="editor-body">
                    <div id="titlediv">
                    	<input name="name" id="title" type="text" value="<?php echo $action == 'edit' ? stripslashes($slider['name']) : __('My Slider', 'slider_pro'); ?>"/>
                    </div>
            ...
            <div class="inner-sidebar meta-box-sortables ui-sortable">
				...
				<div class="postbox action">
					<div class="inside">
						...
						<?php
							if ($action == 'edit') {
								$url = wp_nonce_url(admin_url("admin.php?page=slider_pro&action=delete&id=$slider_id&name=" . $slider['name']), 'delete-slider');
								$preview_params = "&id=$slider_id&name=" . $slider['name'] . '&width=' . $slider_settings['width'] . '&height=' . $slider_settings['height'];
						?> 		
					...
					<div class="inside">
						...
						<fieldset>
							<legend><?php _e('Style', 'slider_pro'); ?></legend>
								...
								<input name="slider_settings[width]" type="text" value="<?php echo sliderpro_get_setting($slider_settings, 'width'); ?>" />
								
								<label title="height"><?php _e('Height', 'slider_pro'); ?></label>
								<input name="slider_settings[height]" type="text" value="<?php echo sliderpro_get_setting($slider_settings, 'height'); ?>" />
								...
								<select name="slider_settings[skin]">
									<?php
										...
										usort($sliderpro_main_skins, "sliderpro_compare_skin_names");
										
										foreach ($sliderpro_main_skins as $skin) {
				...
				foreach ($sidebar_panel_settings as $category_name => $category) {
					...
					echo SP_IND_2 . '<a class="button-secondary show" href="' . admin_url("admin-ajax.php?action=sliderpro_show_slider_settings") . '">Show</a>' . PHP_EOL;
				...
				<div class="postbox">
					<div class="handlediv"></div>
					<h3 class="hndle"><?php _e('Custom JavaScript & CSS', 'slider_pro'); ?></h3>
					<div class="inside">
						...
						<p class="edit-custom-js-css-notice">
