...
$dates_all = $wpdb->get_results("SELECT DISTINCT LEFT(post_date, 7) AS date FROM $table_name WHERE post_type='attachment' AND post_mime_type LIKE 'image%' ORDER BY post_date DESC", ARRAY_A);
	...
	<tbody>
    	...
    	foreach ($images as $image) {
            ...
            echo '<tr>'.
					...
					'<td><a class="button ' . $button_class . '" href="' . $image_path . '">Insert</a></td>'.
				 '</tr>';
        }
		?>    	
	</tbody>
